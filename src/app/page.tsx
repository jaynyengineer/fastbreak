          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Link href="#" aria-label="Facebook" className="text-gray-400 hover:text-cyan-400">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                </Link>
                <Link href="#" aria-label="X (formerly Twitter)" className="text-gray-400 hover:text-cyan-400">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.146 1.364h3.148L13.33 10.9l9.03 11.736h-7.06l-5.534-6.738-6.326 6.738H.294l9.632-10.26L.992 1.364h7.28l4.986 6.028 4.888-6.028z"/></svg>
                </Link>
                <Link href="#" aria-label="Instagram" className="text-gray-400 hover:text-cyan-400">
